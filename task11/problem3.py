# У вас есть пулл адрессов (можно использовать https://httpbin.org/ ).  Создать 2-3 функции которые будут делать
# реквесты к этому адресу. Ваши реквесты должны быть асинхронны с использованием asyncio
import asyncio
import time
import aiohttp
